...
excel_filename_NCEP = 'C:/Users/hatzv/Documents/Geography/RSTs/python/Analysis/Results/RST_classification_NCEP_' + str(NCEP_start_year) + '-' + str(NCEP_end_year) + '.xlsx'
