...
wb = load_workbook('C:/Users/hatzv/Documents/Geography/RSTs/python/Analysis/Results/Kuri_synoptic_classification_2000_2004.xlsx', data_only=True) # data_only means getting the real values and not the functions in a cell
ws = wb['Sheet1']
